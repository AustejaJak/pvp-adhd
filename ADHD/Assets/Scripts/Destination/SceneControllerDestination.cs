    ...
    void InitializeLevels(int index)
    {
        ...
        switch (index)
        {
            case 0:
                ...
                spawnerPrefab.transform.position = new Vector2(1.5f, -3f);//Obeject position

                GameObject Switch1 = Instantiate(switchPrefab);
                Switch1.transform.position = new Vector2(0f, -3f);//Obeject position
                ...
                Waypoint1.transform.position = new Vector2(-1.5f, -3f);//Obeject position
                ...
                //y=-2
                destinationPrefabs[0].transform.position = new Vector2(-1.5f, -1f);//Obeject position
                ...
                Switch2.transform.position = new Vector2(0f, 1f);//Obeject position
                ...
                destinationPrefabs[1].transform.position = new Vector2(-1.5f, 1f);//Obeject position
                ...
                Waypoint2.transform.position = new Vector2(1.5f, 1f);//Obeject position
                ...
                //y=2
                destinationPrefabs[2].transform.position = new Vector2(0f, 3f);//Obeject position
                switchComponent2.switchWaypoints[0] = destinationPrefabs[2].transform; //Train comes from
                switchComponent2.switchRotations[0] = 270;

                destinationPrefabs[3].transform.position = new Vector2(1.5f, 3f);//Obeject position
                ...
                Track1.transform.position = new Vector3(1.5f, -3f, 1f);
                Track1.transform.rotation = Quaternion.Euler(0f, 0f, 90f);
                Track1.transform.localScale = new Vector3(0.1f, 1.5f, 1f);
                GameObject Track2 = Instantiate(trackPrefab);
                Track2.transform.position = new Vector3(0f, -3f, 1f);
                Track2.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
                GameObject Track3 = Instantiate(trackPrefab);
                Track3.transform.position = new Vector3(0f, 1f, 1f);
                ...
                Track4.transform.position = new Vector3(1.5f, 1f, 1f);
                ...
                Track5.transform.position = new Vector3(1.5f, 1f, 1f);
                Track5.transform.rotation = Quaternion.Euler(0f, 0f, 90f);
                Track5.transform.localScale = new Vector3(0.1f, 1.5f, 1f);
                GameObject Track6 = Instantiate(trackPrefab);
                Track6.transform.position = new Vector3(-1.5f, -3f, 1f);
            ...
            case 1:
                ...
                spawnerPrefab.transform.position = new Vector2(1.5f, 3f);

                Waypoint1 = Instantiate(waypointPrefab);
                Waypoint1.transform.position = new Vector2(1.5f, 1f);
                ...
                Switch1.transform.position = new Vector2(0f, 1f);
                ...
                destinationPrefabs[0].transform.position = new Vector2(0f, 3f);
                switchComponent1.switchWaypoints[0] = destinationPrefabs[0].transform;
                switchComponent1.switchRotations[0] = 90;

                destinationPrefabs[1].transform.position = new Vector2(-1.5f, 1f);
                ...
                Switch2.transform.position = new Vector2(0f, -3f);
                ...
                destinationPrefabs[2].transform.position = new Vector2(-1.5f, -3f);
                switchComponent2.switchWaypoints[0] = destinationPrefabs[2].transform;
                switchComponent2.switchRotations[0] = 270;

                destinationPrefabs[3].transform.position = new Vector2(1.5f, -3f);
                ...
                Track4.transform.position = new Vector3(1.5f, 1f, 1f);
                Track4.transform.rotation = Quaternion.Euler(0f, 1f, 0f);
                Track4.transform.localScale = new Vector3(0.1f, 1f, 1f);
            ...
            case 2:
                ...
                Switch1 = Instantiate(switchPrefab);
                Switch1.transform.position = new Vector2(0f, 3f);
                Switch1.transform.rotation = Quaternion.Euler(0f, 0f, 270f);
                switchComponent1 = Switch1.GetComponent<Switch>();
                spawnerComponent.initialWaypoint = Switch1.transform;

                destinationPrefabs[0].transform.position = new Vector2(1.5f, 3f);
                switchComponent1.switchWaypoints[0] = destinationPrefabs[0].transform;
                switchComponent1.switchRotations[0] = 180;

                Switch2 = Instantiate(switchPrefab);
                Switch2.transform.position = new Vector2(0f, -1f);
                ...
                Switch3.transform.position = new Vector2(-1.5f, -1f);
                ...
                destinationPrefabs[2].transform.position = new Vector2(-1.5f, 1f);
                ...
                Track1 = Instantiate(trackPrefab);
                Track1.transform.position = new Vector3(1.5f, -1f, 1f);
                Track1.transform.rotation = Quaternion.Euler(0f, 0f, 90f);
                Track1.transform.localScale = new Vector3(0.1f, 1.5f, 1f);
                Track2 = Instantiate(trackPrefab);
                Track2.transform.position = new Vector3(0f, -1f, 1f);
                Track2.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
                Track3 = Instantiate(trackPrefab);
                Track3.transform.position = new Vector3(0.2f, 3.1f, 1f);
                Track3.transform.rotation = Quaternion.Euler(0f, 0f, 90f);
                Track3.transform.localScale = new Vector3(0.1f, 1f, 1f);
                Track4 = Instantiate(trackPrefab);
                Track4.transform.position = new Vector3(1.5f, 3.1f, 1f);
                Track4.transform.rotation = Quaternion.Euler(0f, 0f, 90f);
                Track4.transform.localScale = new Vector3(0.1f, 1f, 1f);
                Track5 = Instantiate(trackPrefab);
                Track5.transform.position = new Vector3(-1.5f, -3f, 1f);
            ...
            case 3:
                ...
                Switch1 = Instantiate(switchPrefab);
                Switch1.transform.position = new Vector2(1.5f, -1f);
                ...
                Switch2 = Instantiate(switchPrefab);
                Switch2.transform.position = new Vector2(-1.5f, -1f);
                switchComponent2 = Switch2.GetComponent<Switch>();
                switchComponent1.switchWaypoints[1] = Switch2.transform;
                switchComponent1.switchRotations[1] = 180;

                destinationPrefabs[1].transform.position = new Vector2(-1.5f, -3f);
                ...
                destinationPrefabs[3].transform.position = new Vector2(0f, 1f);
                switchComponent3.switchWaypoints[1] = destinationPrefabs[3].transform;
                switchComponent3.switchRotations[1] = 0;
                ...
                Track2 = Instantiate(trackPrefab);
                Track2.transform.position = new Vector3(1.5f, -1f, 1f);
                Track2.transform.rotation = Quaternion.Euler(0f, 0f, 90f);
                Track2.transform.localScale = new Vector3(0.1f, 1.5f, 1f);
                Track3 = Instantiate(trackPrefab);
                Track3.transform.position = new Vector3(0f, 1f, 1f);
                Track3.transform.rotation = Quaternion.Euler(0f, 0f, 90f);
                Track3.transform.localScale = new Vector3(0.1f, 0.7f, 1f);
                Track4 = Instantiate(trackPrefab);
                Track4.transform.position = new Vector3(1.5f, -3f, 1f);
                Track4.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
                Track4.transform.localScale = new Vector3(0.1f, 1f, 1f);
                Track5 = Instantiate(trackPrefab);
                Track5.transform.position = new Vector3(-1.5f, -3f, 1f);
                ...
                Track6.transform.position = new Vector3(-1.5f, 1f, 1f);
                Track6.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
                Track6.transform.localScale = new Vector3(0.1f, 1f, 1f);
                break;
            case 4:
                ...
                Waypoint1 = Instantiate(waypointPrefab);
                Waypoint1.transform.position = new Vector2(1.5f, -3f);
                waypointComponent1 = Waypoint1.GetComponent<Switch>();
                spawnerComponent.initialWaypoint = Waypoint1.transform;
                ...
                destinationPrefabs[0].transform.position = new Vector2(0f, -1f);
                switchComponent1.switchWaypoints[0] = destinationPrefabs[0].transform;
                ...
                destinationPrefabs[3].transform.position = new Vector2(-1.5f, -1f);
                switchComponent3.switchWaypoints[1] = destinationPrefabs[3].transform;
                switchComponent3.switchRotations[1] = 0;
                ...
                Track1.transform.localScale = new Vector3(0.1f, 1.5f, 1f);
                Track2 = Instantiate(trackPrefab);
                Track2.transform.position = new Vector3(1.5f, -3f, 1f);
                Track2.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
                Track3 = Instantiate(trackPrefab);
                Track3.transform.position = new Vector3(1.5f, -1f, 1f);
                Track3.transform.rotation = Quaternion.Euler(0f, 0f, 90f);
                Track3.transform.localScale = new Vector3(0.1f, 0.9f, 1f);
                Track4 = Instantiate(trackPrefab);
                Track4.transform.position = new Vector3(1.5f, 1f, 1f);
                Track4.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
                Track4.transform.localScale = new Vector3(0.1f, 1f, 1f);
                ...
                Track7.transform.position = new Vector3(-1.5f, -1f, 1f);
